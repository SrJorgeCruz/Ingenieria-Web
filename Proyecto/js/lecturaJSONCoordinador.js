const requestURL1 = '../Estudiantes/listaAlumnos.json';
...
request1.onload = function() {
    ...
    populateSelect(datos);
}

function populateSelect(jsonObj) {
    const alumnos = jsonObj['alumnos'];
    ...
    for (var i = 0; i < alumnos.length; i++) {
        ...
        myOption.value = alumnos[i].CURP;
        myOption.textContent = alumnos[i].nombre;
...
selectAlumnos.addEventListener("change", function(ev){
    ...
    const requestURL2 = '../Estudiantes/Productividad/'+selectAlumnos.value+'.json';
